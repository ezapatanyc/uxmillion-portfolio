...
export const GRADIENT_COLORS = {
  ...
  purple: [
    { color: "var(--gradient-purple-1)", start: "0%" },
    { color: "var(--gradient-purple-2)", start: "22.92%" },
    { color: "var(--gradient-purple-3)", start: "42.71%" },
    { color: "var(--gradient-purple-4)", start: "88.54%" },
  ],
  green: [
...
const TRANSITION_CONFIG = { ease: "easeOut" as const, duration: 0.5 }
...
function Word({
  ...
  return (
    <motion.span
      className="inline-block text-nowrap align-top"
    ...
    >
      {words.map((word, index) => (
        <React.Fragment key={index}>
          <Word transition={transition} direction={direction} word={word} stagger={stagger} />
